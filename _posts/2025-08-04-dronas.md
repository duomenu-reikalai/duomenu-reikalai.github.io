...
![Be Dopplerio efekto analizės trajektorijos tiksliai nenustatysi](/assets/img/dronas/teorines_galimos_trajektorijos.jpeg)
...
![Galimų praskridimo taškų samplinimas ir trajektorijos tikimybės](/assets/img/dronas/labiausiai_tiketinos_trajektorijos.jpg)
...
![Be Dopplerio efekto analizės nustatyta trajektorija dideliuose atstumuose tampa bevertė](/assets/img/dronas/trajektorijos_netikslumas.jpg)
...
![Skrydžiai, kuriems neprytaikysi Dopplerio efekto analizės](/assets/img/dronas/bedaznis_skrydis.jpeg)
...
![Dopplerio efekto esmė](/assets/img/dronas/doplerio_efektas.png)
...
![Matematiškai apskaičiuoti dažnių profiliai ir stebėjimo rezultatai](/assets/img/dronas/doplerio_efekto_analize.png)
...
![Daug galimybių trajektorijai liesti sferą](/assets/img/dronas/sfera.png)

Visų antra, trajektorijos bendroji (apytikslė) kryptis yra žinoma, todėl kupolas virsta arka:

![Mažiau galimų trajektorijų, jei žinoma bendra kryptis](/assets/img/dronas/arka.png)
...
![Tik dvi trajektorijos kurios tam tikra kryptimi liečia sferą tam tikrame aukštyje](/assets/img/dronas/segmentas.png)


Tad žiūrint iš viršaus, yra tik dvi galimos drono praskridimo lokalizacijos:

![lokalizacijos schema 1](/assets/img/dronas/schema1.png)

Įstitikinkime, kiek naudinga mums gali būti tokia įžvalga :

![lokalizacijos schema 2](/assets/img/dronas/schema2.png)
...
![Iš keturių garso įrašų atkurti aštuoni galimi praskridimo taškai](/assets/img/dronas/4_tasku_lokacijos.png)
...
![Logikos būdu aštuoni galimi taškai susiaurinti į keturis tikruosius](/assets/img/dronas/interpoliuota_trajektorija.png)
...
![Faktinė drono nukritimo vieta ir apskaičiuota jo skrydžio trajektorija](/assets/img/dronas/nustatyta_trajektorija_ir_kritimas.png)
